...
class Signup extends React.Component {
  ...
  validate = (event) => {
    ...
    switch (name) {
      case "email":
        errors.email = EmailRegex.test(value) ? "Invalid Email" : "Invalid Email";
        break;
      case "password":
          ...
          >
            <div style={{ paddingTop: 20, paddingBottom: 20 }}>
              ...
              >
                ...
                <FormHelperText>{this.state.email.errors}</FormHelperText>
                ...
                <FormHelperText>{this.state.passwordStrength}</FormHelperText>
